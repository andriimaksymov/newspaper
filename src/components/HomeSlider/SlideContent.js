...
const SlideContent = ({ media, section, title, abstract, byline, url, published_date }) => {
        ...
        <Grid container>
            ...
            <Grid item xs={6}>
                <div className={classes.slideContent}>
                    <Typography gutterBottom component="span" className={classes.caption}>{section}</Typography>
